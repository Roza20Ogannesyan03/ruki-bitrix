...
<head>
	...
	<link rel="apple-touch-icon" sizes="57x57" href="<?php echo SITE_TEMPLATE_PATH ?>/assets/favicon/apple-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="180x180" href="<?php echo SITE_TEMPLATE_PATH ?>/assets/favicon/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="<?php echo SITE_TEMPLATE_PATH ?>/assets/favicon/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="<?php echo SITE_TEMPLATE_PATH ?>/assets/favicon/favicon-16x16.png">
	<link rel="manifest" href="<?php echo SITE_TEMPLATE_PATH ?>/assets/favicon/site.webmanifest">
	<link rel="mask-icon" href="<?php echo SITE_TEMPLATE_PATH ?>/assets/favicon/safari-pinned-tab.svg" color="#ffffff">
