...
<div class="studio">
	<div class="studio__img-container">
		<?php
		$APPLICATION->IncludeFile('/include/index_studio_image.php', array(), array('MODE' => 'html'));
	...
	<div class="studio__right">
		<div class="studio__text-wrapper">
			<h2 class="block-title">
				<?php
				$APPLICATION->IncludeFile('/include/index_studio_title.php', array(), array('MODE' => 'text'));

				?> </h2>
			<div class="studio__text">
				<?php
				$APPLICATION->IncludeFile('/include/index_studio_text.php', array(), array('MODE' => 'text'));

				?>
			</div>
			<a href="/studio/" class="link-beige">Подробнее <img src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/studio-arrow.svg" class="arrow-beige" alt=""></a>
		</div>
	</div>
</div>
...
<div class="container">
	<div class="seo-text-container">
		<h1 class="block-title">
			<?php
			$APPLICATION->IncludeFile('/include/index_seo_title.php', array(), array('MODE' => 'text'));

			?> </h1>
		<p class="seo-text">
			<?php
			$APPLICATION->IncludeFile('/include/index_seo_text.php', array(), array('MODE' => 'text'));
